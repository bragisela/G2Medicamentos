            ...
            <div class="col-md-12">
                <?php if($_GET): ?>
                    ...
                    <div class="row g-3">
                        ...
                        <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="1Cod_medico" value="<?php echo $resultado_unico['1Cod_medico']?>" required onchange="Caps()">
                        ...
                        <div class="col-12">
                        <label for="text" class="form-label">Codigo Medicamento</label>
                        <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="2Cod_medico" value="<?php echo $resultado_unico['2Cod_medico']?>" required onchange="Caps()">
                        <option value="0">Seleccione:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</option>
