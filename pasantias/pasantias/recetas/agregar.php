...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO recetas (Fecha,Apellido,Nombres,Tipo_DNI,Nro_DNI,Fecha_nacimiento,
        Sexo,1Cod_medico,Cantidad1,2Cod_medico,Cantidad2,Idusuario,mes) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)';
    $agregar = $pdo->prepare($sql_agregar);
    if($rolregister==1){
    $agregar->execute(array($fecha,$apellido,$nombres,$tipo_dni,$nro_dni,$fecha_naci,$sexo,$cod_medico1,$cant1,$cod_medico2,$cant2,$eleccionRegister,$eleccionmes));
    }else{
    $agregar->execute(array($fecha,$apellido,$nombres,$tipo_dni,$nro_dni,$fecha_naci,$sexo,$cod_medico1,$cant1,$cod_medico2,$cant2,$idregister,$eleccionmes));
    }
            ...
            <div class="col-12">
              ...
              <option value="0">Seleccione:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</option>
                ...
                <?php foreach($resultados1 as $dato): ?>
                    ...
                    <option value="<?php echo $dato['Codigo'] ?>"> <?php echo $dato['Medicamento'] ?></option>
