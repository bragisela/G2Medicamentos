...
if($_POST){
    ...
    $sql_agregar = "INSERT INTO clsbotiquin (Medicamento,Stock_inicial,Idusuario,Codigo,mes,Donado) VALUES (?,?,?,?,?,?)";
    $agregar = $pdo->prepare($sql_agregar);
    if($rolregister==1){
    $agregar->execute(array($medicamento,$stockinicial,$eleccionRegister,$codigo,$eleccionmes,$Donado));
    }else{
    $agregar->execute(array($medicamento,$stockinicial,$idregister,$codigo,$eleccionmes,$Donado));
    }
      ...
      <br>
        <div class="form-signin">
          ...
          <div class="col-12">
            ...
            <div class="col-12">
              <label for="text" class="form-label">Donado</label>
              <select class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="Donado" value="" required>
            ...
            <br>
              ...
              <a class="btn btn-primary col-sm-5" href="../clsbotiquin.php" >Volver</a></center>
          </form>
          <br>
<?php endif ?>
            </div>
