...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO salidas (Fecha,Motivo,Cantidad,Cod_medico) VALUES (?,?,?,?)';
    $agregar = $pdo->prepare($sql_agregar);
    $agregar->execute(array($fecha,$motivo,$cantidad,$Cod_Medic));
    ...
    <body>
        ...
        <div class="form-signin">
          ...
          <form method="POST">
              ...
              <h6>Motivo</h6><input type="text" class="form-control mt-3" name="Motivo" >
