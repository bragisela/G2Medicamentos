...
$messiass = "SELECT * FROM medicamentos where mes=$eleccionmes and Idusuario=$idregister";
  $gsentos = $pdo->prepare($messiass);
  $gsentos->execute();
  $resultados1 = $gsentos->fetchAll();
...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO recetas (Fecha,Apellido,Nombres,Tipo_DNI,Nro_DNI,Fecha_nacimiento,
        Sexo,Diagnostico1,Diagnostico2,1Cod_medico,Cantidad1,2Cod_medico,Cantidad2,Idusuario,mes) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
    $agregar = $pdo->prepare($sql_agregar);
    if($rolregister==1){
    $agregar->execute(array($fecha,$apellido,$nombres,$tipo_dni,$nro_dni,$fecha_naci,$sexo,$diagnostico1,$diagnostico2,$cod_medico1,$cant1,$cod_medico2,$cant2,$eleccionRegister,$eleccionmes));
    }else{
    $agregar->execute(array($fecha,$apellido,$nombres,$tipo_dni,$nro_dni,$fecha_naci,$sexo,$diagnostico1,$diagnostico2,$cod_medico1,$cant1,$cod_medico2,$cant2,$idregister,$eleccionmes));
    }
      ...
      <br>
        <div class="form-signin">
          ...
          <div class="col-12">
            ...
            <div class="col-12">
              <label for="Otrocaps" class="form-label">Sexo</label>
              <select class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="Sexo" value="<?php echo $resultado_unico['Sexo'] ?>" required>
            ...
            <div class="col-12">
              <label for="text" class="form-label">Codigo Medicamento</label>
              <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="1Cod_medico" required onchange="Caps()">
              <option value="0">Seleccione:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</option>

                <?php foreach($resultados1 as $dato): ?>
                    
                    <option value="<?php echo $dato['Idmedicamento'] ?>"> <?php echo $dato['Medicamento'] ?></option>
            ...
            <div class="col-12">
              <label for="text" class="form-label">Codigo Medicamento</label>
              <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="2Cod_medico" required onchange="Caps()">
              <option value="0">Seleccione:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</option>
            ...
            <br>
              ...
              <a class="btn btn-primary col-sm-5" href="../recetas.php" >Volver</a></center>
          </form>
<?php endif ?>
            </div>
            </div>
