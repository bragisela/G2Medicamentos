...
$messias = "SELECT Idusuario, Nombre FROM usuarios where Idrol=2 and Idusuario!=$idregister";
        ...
        <div class="form-signin">
          ...
          <div class="col-12">
            ...
            <div class="col-12">
              ...
              <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="Cod_medico" required onchange="Caps()">
            ...
            <div class="col-sm-12">
              ...
              <select type="text" id="usuarios" class="form-control bg-light text-dark" aria-label="form-control bg-light text-dark" name="Otrocaps" onchange="Caps()">
              <option value="0">Seleccione:ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ</option>
            ...
            <br>
              ...
              <a class="btn btn-primary col-sm-5" href="../clearing.php" >Volver</a></center>
          </form>
<?php endif ?>
            </div>
            </div>
