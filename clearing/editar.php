            ...
            <div class="col-md-12">
                <?php if($_GET): ?>
                    ...
                    <form method="GET" action="editarf.php">
                        ...
                        <h5>Salida/Entrada</h5>
                        <input type="text" class="form-control" name="Tipo" value="<?php echo $resultado_unico['Tipo'] ?>">

                        <h5>Recibido/enviado a</h5>
                        <input type="text" class="form-control" name="Otrocaps" value="<?php echo $resultado_unico['Otrocaps'] ?>">

                        <h5>Ingresar Codigo Del CAPS</h5>
