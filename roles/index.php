...
try {
  $pruebaex = "php/registro.php";
   if (!file_exists($pruebaex))
  { throw new Exception("No se pudo encontrar el archivo registro.php");
  }
} catch (Exception $e) {
  echo $e->getMessage();
  die();
...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO usuarios (usuario,clave,email) VALUES (?,?,?)';
    $sentencia_agregar = $pdo->prepare($sql_agregar);
    $sentencia_agregar->execute(array($usuario,$clave,$email));
...
<main class="form-signin">
    ...
    <a href="php/registro.php">Registrarse</a></div>
</main>
  </body>
</html>