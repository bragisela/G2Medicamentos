           ...
           <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td><?php echo $usuario['Stock_inicial']?></td>
                      ...
                      <td>
                      <center>
                        <a href="Stockinicial/editar.php?Idstockinicial=<?php echo $usuario['Idstockinicial']?>"><img src="imagenes/editar.png"/></a>


                        <?php
                        if($rolregister==1){
                        ?> 
                        <a href="Stockinicial/eliminar.php?Idstockinicial=<?php echo $usuario['Idstockinicial']?>" onclick="return confirm('¿Quiere borrar a esta persona?')"><img src="imagenes/borrar.png"/>
                      </a>
                      <?php
                        }
                      ?>
