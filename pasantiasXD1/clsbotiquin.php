       ...
       <div class="row">
           ...
           <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                    <center>
                        <a href="clsbotiquin/editar.php?Idclsbotiquin=<?php echo $usuario['Idclsbotiquin']?>"><img src="imagenes/editar.png"/></a>


                        <?php
                        if($rolregister==1){
                        ?> 
                        <a href="clsbotiquin/eliminar.php?Idclsbotiquin=<?php echo $usuario['Idclsbotiquin']?>" onclick="return confirm('¿Quiere borrar a esta persona?')"><img src="imagenes/borrar.png"/>
                      </a>
                      <?php
                        }
                      ?>
