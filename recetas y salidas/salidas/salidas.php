       ...
       <div class="row">
           ...
           <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                          <center>
                        <a href="editar.php?Idsalidas=<?php echo $usuario['Idsalidas']?>"><img src="https://img.icons8.com/material-outlined/24/000000/edit-file--v2.png"/></a>
                        <a href="eliminar.php?Idsalidas=<?php echo $usuario['Idsalidas']?>" onclick="return confirm('¿Quiere borrar a esta persona?')"><img src="https://img.icons8.com/material-outlined/24/000000/delete-sign.png"/>
                      </a></center>
                  </tr>
                    <?php
                        }
