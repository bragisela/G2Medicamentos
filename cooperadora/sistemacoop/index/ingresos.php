        ...
        <!-- page content -->
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="guardaringreso.php" method="POST"data-parsley-validate class="form-horizontal form-label-left">
                        <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Fecha
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="date" name="fecha" id="Nro"class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                           ...
                           <?php
                  $query_cuentas = mysqli_query($con,"SELECT * from cuentas WHERE idcuenta not in (SELECT DISTINCT idcuentapadre FROM cuentas) AND tipo='I' AND idcuenta<>3");
         ...
         ?>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="text" name="descrip" id="Nro"class="form-control col-md-7 col-xs-12" Nom="" required>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          ...
                          <input type="text" name="importein" id="Nro"class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
