...
<?php
  ...
  //Paso 3 es hacer la sentencia sql y ejecutarla
      $sql="SELECT socios.nombreP, pagodecuotas.montopagado, pagodecuotas.idcuota, pagodecuotas.recibo, registrocuotas.mes, socios.cantihijos FROM pagodecuotas
      ...
      <html>
        ...
        echo '<br />';
          ...
          for($i=0; $i<$pagodecuotas; $i++){
            ...
            echo '------------------------------------------------------------------------------------------------------------------------------------';
            echo '<br />';
            echo 'Monto: ' . $pagodecuotas['montopagado']*$pagodecuotas['cantihijos'] .'<br />';
            echo '------------------------------------------------------------------------------------------------------------------------------------';
            echo '<br />';
            echo '<br />';
