        ...
        <select type="hidden" name="idcuota[]" id="idcuota[]" class="hidden">
          ...
          while ($cuotas = mysqli_fetch_array($query_cuotas)) {
            ...
            $cuotasp = mysqli_fetch_array($query_cuotasp);
                if (isset($cuotasp["idcuota"])!=$cuotas["idcuota"]){
          ...
          <br>
          <br>
          <h2>(Se realizara el pago segun la cantidad de hijos $200 C/U)<br><br></h2>
          <h4>El excedente a 200 se imputara como donacion</h4>
          <div class="x_content">
