...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO stockinicial (Codigo,Medicamento,Stock inicial) VALUES (?,?,?)';
    $sentencia_agregar = $pdo->prepare($sql_agregar);
    $sentencia_agregar->execute(array($codigostockinicial,$medicamentostockinicial,$stockinicialstockinicial));
    $sentencia_agregar = null;
    $pdo = null;
    header('location:editarfstockinicial.php');
}

if($_GET){
    $id = $_GET['id'];
    $sql_unico = 'SELECT * FROM stockinicial WHERE id=?';
...
<html lang="en">
  <head>
    ...
    <body>
        ...
        <form method="GET" action="editarfstockinicial.php">
          <div class="row g-3">
            <div class="col-sm-6">
