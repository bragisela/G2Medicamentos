...
if($_POST){
    ...
    $sql_agregar = 'INSERT INTO salidas (Fecha,Cod. Medic.,Cantidad,Motivo) VALUES (?,?,?,?)';
    $sentencia_agregar = $pdo->prepare($sql_agregar);
    $sentencia_agregar->execute(array($fechasalidas,$codmedicsalidas,$cantidadsalidas,$motivosalidas));
    $sentencia_agregar = null;
    $pdo = null;
    header('location:editarfsalidas.php');
}

if($_GET){
    $id = $_GET['id'];
    $sql_unico = 'SELECT * FROM salidas WHERE id=?';
...
<html lang="en">
  <head>
    ...
    <body>
        ...
        <form method="GET" action="editarfsalidas.php">
          <div class="row g-3">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <input type="" class="form-control"  name="Caps" placeholder="" value="<?php echo $resultado_unico['Cantidad'] ?>" required>
              <span id="alerta"></span>
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="" class="form-control" name="Cantidad" value="<?php echo $resultado_unico['Motivo'] ?>" required >
              <div class="invalid-feedback">
                Please enter a valid email address for shipping updates.
              </div>
            </div>
