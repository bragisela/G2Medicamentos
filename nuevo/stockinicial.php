       ...
       <div class="row">
           ...
           <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                        <a href="editarstockinicial.php?id=<?php echo $usuario['id']?>"><i class="fas fa-pencil-alt"></i></a>
                        <a href="eliminarstockinicial.php?id=<?php echo $usuario['id']?>" class="float-right" onclick="return confirmar()"><i class="fas fa-trash-alt"></i></a>
                    </tr>
                    <?php
                        }
                    ?>
