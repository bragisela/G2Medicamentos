CREATE DATABASE IF NOT EXISTS dappiano;
USE dappiano;
...
INSERT INTO `crud` (`user_id`, `username`, `first_name`, `last_name`, `gender`, `password`, `status`) VALUES
...
CREATE TABLE `registro` (
  `id_usuario` int(10) NOT NULL NULL AUTO_INCREMENT PRIMARY KEY,
