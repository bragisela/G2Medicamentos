       ...
       <div class="row">
           ...
           <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <td>
                    <center>
                        <a href="recetas/editar.php?Idrecetas=<?php echo $usuario['Idrecetas']?>"><img src="imagenes/editar.png"/></a>


                        <?php
                        if($rolregister==1){
                        ?> 
                        <a href="recetas/eliminar.php?Idrecetas=<?php echo $usuario['Idrecetas']?>" onclick="return confirm('¿Quiere borrar a esta persona?')"><img src="imagenes/borrar.png"/>
                      </a>
                      <?php
                        }
                      ?>
